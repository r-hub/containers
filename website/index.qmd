...
| r-devel-linux-x86_64-debian-gcc   | ubuntu-gcc16    | `r os_name("ubuntu-gcc16")`    | `r r_ver("ubuntu-gcc16")`    | [Details](containers.html#ubuntu-gcc16)    |
...
|BLIS        | blis       | Tests with alternative BLAS/LAPACK implementations               | `r os_name("blis")`               | `r r_ver("blis")`       | [Details](containers.html#blis)        |
...
|clang21     | clang21    | Checks with LLVM 21.x                                            | `r os_name("clang21")`, libc++    | `r r_ver("clang21")`    | [Details](containers.html#clang21)     |
|clang22     | clang22    | Checks with LLVM 22.x                                            | `r os_name("clang22")`, libc++    | `r r_ver("clang22")`    | [Details](containers.html#clang22)     |
|clang23     | clang23    | Checks with LLVM 23.x                                            | `r os_name("clang23")`, libc++    | `r r_ver("clang23")`    | [Details](containers.html#clang23)     |
|            | debian-clang| Checks on Debian with LLVM 23.x                                 | `r os_name("debian-clang")`       | `r r_ver("debian-clang")`| [Details](containers.html#debian-clang)|
|donttest    | donttest   | Tests including `\donttest` examples                             | `r os_name("donttest")`           | `r r_ver("donttest")`   | [Details](containers.html#donttest)    |
|gcc16       | gcc16      | Checks with GCC trunk aka 16.0                                   | `r os_name("gcc16")`              | `r r_ver("gcc16")`      | [Details](containers.html#gcc16)       |
...
|vnu         | vnu        | Tests of HTML and CSS validation using the W3C Nu Validator      | `r os_name("vnu")`                | `r r_ver("vnu")`        | [Details](containers.html#vnu)         |
...
Deprecated containers are not updated any more.
...
|            | ubuntu-gcc12| ex r-devel-linux-x86_64-debian-gcc                               | `r os_name("ubuntu-gcc12")`       | `r r_ver("ubuntu-gcc12")`| [Details](containers.html#ubuntu-gcc12)|
|            | ubuntu-gcc15| ex r-devel-linux-x86_64-debian-gcc                               | `r os_name("ubuntu-gcc15")`       | `r r_ver("ubuntu-gcc15")`| [Details](containers.html#ubuntu-gcc15)|
</details>
